...
public:
	...
	lockfree_spsc_bounded(lockfree_spsc_bounded &&) = delete; // move constructor deleted...
	lockfree_spsc_bounded &operator=(lockfree_spsc_bounded &&) = delete; // move assignment operator deleted...
